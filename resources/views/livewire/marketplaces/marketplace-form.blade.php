                ...
                <x-ui.card title="Credenciais de API">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="url" id="api_url" wire:model="api_url" class="form-input text-sm" placeholder="https://api.mercadolibre.com">
                ...
                <x-ui.card title="Marketplace">
                    <div class="space-y-4">
                        <div>
                            ...
                            <select id="marketplace_type" wire:model="marketplace_type" class="form-input">
                                @foreach($types as $t)
