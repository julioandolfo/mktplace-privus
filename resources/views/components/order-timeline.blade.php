...
@php
    ...
    $allSteps = [
        ...
        'purchase_requested'    => ['Compra solicitada',         'heroicon-o-shopping-cart',          'amber'],
        'purchase_completed'    => ['Compra realizada',          'heroicon-o-check-badge',            'teal'],
        ...
        'sent_to_production'    => ['Enviado para produção',     'heroicon-o-paper-airplane',         'orange'],
        ...
        'packing_checked'       => ['Conferência de embalagem',  'heroicon-o-clipboard-document-check','slate'],
        ...
        <div class="space-y-1">
            ...
            @php
                ...
                $colors = [
                    ...
                    'amber'  => 'bg-amber-100 dark:bg-amber-900/40 text-amber-600 dark:text-amber-400 ring-amber-200 dark:ring-amber-800',
                    'teal'   => 'bg-teal-100 dark:bg-teal-900/40 text-teal-600 dark:text-teal-400 ring-teal-200 dark:ring-teal-800',
